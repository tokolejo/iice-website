...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#2e0d42] border-t border-white/4 pt-5 pb-10 text-white transition-all duration-300 relative overflow-hidden">
            ...
            <div className="absolute -top-40 -right-40 w-96 h-96 bg-white/5 rounded-full blur-3xl animate-float-blob-slow"></div>
            <div className="absolute top-20 -left-20 w-72 h-72 bg-[#AD49E1]/20 rounded-full blur-3xl animate-float-blob-reverse"></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
                    ...
                    <ScrollReveal delay={200} className="lg:col-span-3">
                        ...
                        <ul className="space-y-3 md:space-y-4 text-sm md:text-base font-bold text-white">
                            ...
                            <li><Link href="/news?category=seminars" className="text-white hover:text-white/80 transition-colors flex items-center gap-2 group"><span className="w-1.5 h-1.5 rounded-full bg-[#AD49E1] scale-0 group-hover:scale-100 transition-transform"></span>{t.nav.seminars}</Link></li>
                        </ul>
                    </ScrollReveal>
