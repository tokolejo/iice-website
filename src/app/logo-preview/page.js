...
const VERSIONS = [
    {
        ...
        titleKa: 'ვერსია 3A: არქიტექტურული ნახატით — ქართული („იიცე“)',
        titleEn: 'Version 3A: Architectural Line Drawing — Georgian ("იიცე")',
        badgeKa: 'ოფიციალური არჩევანი • კოლბების გარეშე',
        badgeEn: 'OFFICIAL CHOSEN • NO FLASKS',
        descKa: 'თქვენ მიერ გამოგზავნილი ინსტიტუტის შენობის არქიტექტურული ხაზობრივი ნახატი „0“-ში. „7“-ის ძირი სრულიად სუფთაა (ყოველგვარი კოლბების გარეშე), ზემოთ „იიცე“, ქვემოთ „1956 — 2026“, ლენტზე „70 წლის იუბილე“.',
        descEn: 'Features the architectural building line drawing you uploaded inside the "0". Clean 3D "7" without any chemical flasks. "იიცე" at top, "1956 — 2026" at bottom, and "70 წლის იუბილე" on the ribbon.',
        imgSrc: '/conference-2026/iice-70-clean-geo.png',
        downloadName: 'iice-70-arch-geo.png',
        lang: 'ka',
        buildingType: 'არქიტექტურული ნახატი (თქვენი გამოგზავნილი)',
        hasChem: false
    },
    {
        id: 'v3-arch-eng',
        category: 'ოფიციალური არჩევანი (საიტზე აქტიური)',
        titleKa: 'ვერსია 3A: არქიტექტურული ნახატით — ინგლისური („IICE“)',
        titleEn: 'Version 3A: Architectural Line Drawing — English ("IICE")',
        badgeKa: 'ოფიციალური საერთაშორისო • კოლბების გარეშე',
        badgeEn: 'OFFICIAL INTERNATIONAL • NO FLASKS',
        descKa: 'საერთაშორისო გამოცემა შენობის არქიტექტურული ნახატით, კოლბების გარეშე: ზემოთ „IICE“, ქვემოთ „1956 — 2026“, ლენტზე „ANNIVERSARY“.',
        descEn: 'International edition featuring the architectural building line drawing inside the "0", clean "7" with no flasks, "IICE" at top, "1956 — 2026" at bottom, and ribbon.',
        imgSrc: '/conference-2026/iice-70-clean-eng.png',
        downloadName: 'iice-70-arch-eng.png',
        lang: 'en',
        buildingType: 'არქიტექტურული ნახატი (თქვენი გამოგზავნილი)',
        hasChem: false
    },
    {
        ...
        titleKa: 'ვერსია 3A (კოლბებით): არქიტექტურული ნახატი + ქიმიური კოლბები',
        titleEn: 'Version 3A (With Flasks): Architectural Drawing + Chemical Flasks',
        badgeKa: 'არქიტექტურული + კოლბები',
        badgeEn: 'ARCHITECTURAL + FLASKS',
        descKa: 'არქიტექტურული შენობის ხაზობრივი ნახატი „0“-ში + კოლბები „7“-ის ძირში.',
        descEn: 'Features the architectural line drawing inside the "0" with crystal laboratory flasks at the base of "7".',
    ...
    },
    {
        id: 'v3-real-chem',
        category: 'სხვა ვარიანტები (არქივი)',
        titleKa: 'ვერსია 3B (კოლბებით): რეალური შენობის ფოტოთი + ქიმიური კოლბები',
        titleEn: 'Version 3B (With Flasks): Real Building with Trees + Chemical Flasks',
        badgeKa: 'რეალური შენობა + კოლბები',
        badgeEn: 'REAL BUILDING + FLASKS',
        descKa: 'ინსტიტუტის რეალური ფერადი შენობა და მწვანე ნაძვები „0“-ში + ქიმიური კოლბები.',
        descEn: 'Authentic color photograph of the institute building with green pine trees inside the "0" with crystal flasks.',
    ...
    },
    {
        ...
        descKa: 'სუფთა წრიული სილუეტი, სადაც შენობის თავზე ცაში ნაზად არის ინტეგრირებული ინსტიტუტის ლოგოს ციკლური ვოლტამპეროგრამა.',
        descEn: 'Clean circular ring subtly tracing the official cyclic voltammetry curve in the sky above the building.',
...
export default function LogoPreviewPage() {
    const [selectedId, setSelectedId] = useState('v3-arch-geo');
